...
class TierCalcSpec extends FlatSpec with Matchers with Inside {
  def createTierCalc = TierCalcImpl(dir=LongDir)
  ...
  "TierCalc" should "calculate tiers" in {
    ...
    createTierCalc.canOpenWithQty(10.0,  Seq()) shouldBe Some(0.14873869585911467)
    ...
    createTierCalc.canOpenWithQty(9.5,   Seq(10.0)) shouldBe Some(0.11899095668729175)
    createTierCalc.canOpenWithQty(9.026, Seq(10.0)) shouldBe Some(0.11899095668729175)

    createTierCalc.canOpenWithQty(9.024, Seq(10.0, 9.3, 9.0)) shouldBe None
    createTierCalc.canOpenWithQty(9.024, Seq(10.0, 9.3)) shouldBe Some(0.09519276534983341)
    createTierCalc.canOpenWithQty(8.574, Seq(10.0, 9.3)) shouldBe Some(0.09519276534983341)

    createTierCalc.canOpenWithQty(8.4,   Seq(10.0, 9.3, 9.0, 8.3)) shouldBe None
    createTierCalc.canOpenWithQty(8.573, Seq(10.0, 9.3, 9.0)) shouldBe Some(0.07615421227986673)
    createTierCalc.canOpenWithQty(8.146, Seq(10.0, 9.3, 9.0)) shouldBe Some(0.07615421227986673)

    createTierCalc.canOpenWithQty(8.0,   Seq(10.0, 9.3, 9.0, 8.3, 7.9)) shouldBe None
    createTierCalc.canOpenWithQty(8.145, Seq(10.0, 9.3, 9.0, 8.3)) shouldBe Some(0.06092336982389338)
    createTierCalc.canOpenWithQty(7.738, Seq(10.0, 9.3, 9.0, 8.3)) shouldBe Some(0.06092336982389338)
