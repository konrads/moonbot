...
class LedgerSpec extends FlatSpec with Matchers with Inside {
  ...
  it should "work for incremental and full pandl" in {
    ...
    metrics5 shouldBe LedgerMetrics(Map("data.price" -> -1.0, "data.pandl.pandl" -> 0.3524439102564103, "data.pandl.delta" -> 0.3524439102564103, "data.sentiment" -> 1.0, "data.myTradeCnt" -> 3, "data.volume" -> 0.0), "o5", 0.3524439102564103)
    ...
    metrics7 shouldBe LedgerMetrics(Map("data.price" -> -1.0, "data.pandl.pandl" -> 1.6008814102564104, "data.pandl.delta" -> 1.2484375, "data.sentiment" -> 1.0, "data.myTradeCnt" -> 4, "data.volume" -> 0.0), "o7", 1.6008814102564104)
    ...
    metrics9 shouldBe  LedgerMetrics(Map("data.price" -> -1.0, "data.pandl.pandl" -> 1.6008814102564104, "data.pandl.delta" -> 0, "data.sentiment" -> 1.0, "data.myTradeCnt" -> 5, "data.volume" -> 0), "o7", 1.6008814102564104)
  }
