...
object ModelsSpec {
  ...
  def restOrderNew(orderID: String, side: OrderSide.Value, price: BigDecimal = null, orderQty: BigDecimal, ordType: OrderType.Value, timestamp: String) = ordType match {
    case OrderType.Limit =>
      s"""{"orderID":"$orderID","clOrdID":"${orderID}__balls","clOrdLinkID":"","account":299045,"symbol":"XBTUSD","side":"$side","simpleOrderQty":null,"orderQty":$orderQty,"price":$price,"displayQty":null,"stopPx":null,"pegOffsetValue":null,"pegPriceType":"","currency":"USD","settlCurrency":"XBt","ordType":"Limit","timeInForce":"GoodTillCancel","execInst":"ParticipateDoNotInitiate","contingencyType":"","exDestination":"XBME","ordStatus":"New","triggered":"","workingIndicator":true,"ordRejReason":"","simpleLeavesQty":null,"leavesQty":30,"simpleCumQty":null,"cumQty":0,"avgPx":null,"multiLegReportingType":"SingleSecurity","text":"Submitted via API.","transactTime":"$timestamp","timestamp":"$timestamp"}"""
    case OrderType.Market =>
      s"""{"orderID":"$orderID","clOrdID":"${orderID}__balls","clOrdLinkID":"","account":299045,"symbol":"XBTUSD","side":"$side","simpleOrderQty":null,"orderQty":$orderQty,"price":$price,"displayQty":null,"stopPx":null,"pegOffsetValue":null,"pegPriceType":"","currency":"USD","settlCurrency":"XBt","ordType":"Market","timeInForce":"GoodTillCancel","execInst":"","contingencyType":"","exDestination":"XBME","ordStatus":"Filled","triggered":"","workingIndicator":false,"ordRejReason":"","simpleLeavesQty":null,"leavesQty":0,"simpleCumQty":null,"cumQty":$orderQty,"avgPx":$price,"multiLegReportingType":"SingleSecurity","text":"Submitted via API.","transactTime":"$timestamp","timestamp":"$timestamp"}"""
    case OrderType.Stop =>
      s"""{"orderID":"$orderID","clOrdID":"${orderID}__balls","clOrdLinkID":"","account":299045,"symbol":"XBTUSD","side":"$side","simpleOrderQty":null,"orderQty":$orderQty,"price":null,"displayQty":null,"stopPx":$price,"pegOffsetValue":null,"pegPriceType":"","currency":"USD","settlCurrency":"XBt","ordType":"Stop","timeInForce":"GoodTillCancel","execInst":"LastPrice","contingencyType":"","exDestination":"XBME","ordStatus":"New","triggered":"","workingIndicator":false,"ordRejReason":"","simpleLeavesQty":null,"leavesQty":$orderQty,"simpleCumQty":null,"cumQty":0,"avgPx":null,"multiLegReportingType":"SingleSecurity","text":"Submitted via API.","transactTime":"$timestamp","timestamp":"$timestamp"}"""
    case other =>
